...
const SKILL_NAME = 'Excuse Generator';
const WELCOME_MESSAGE = "Weclome to excuse generator, start by asking me: Why am I late? Why didnt I do my homework? or Why cant I go out? and I will response with an excuse!";
const HELP_MESSAGE = 'You can ask me a question like: Why am I late? Why didnt I do my homework? or Why cant I go out? and I will response with an excuse!';
const HELP_REPROMPT = 'What can I help you with?';
const STOP_MESSAGE = 'Goodbye!';

const GET_EXCUSE_LATE_START = "Okay your late excuse is: ";
const GET_EXCUSE_HOMEWORK_START = "Okay your homework excuse is: ";
const GET_EXCUSE_ATTENDING_START = "Okay your attending excuse is: ";

const DATA_LATE_EXCUSES = [
    "I've earned it",
    "My car won't start",
...
const handlers = {
    ...
    'GetLateExcuseIntent': function () {
        ...
        const excuseArray = DATA_LATE_EXCUSES;
        const excuseIndex = Math.floor(Math.random() * excuseArray.length);
        const randomExcuse = excuseArray[excuseIndex];
        const speechOutput = GET_EXCUSE_LATE_START + randomExcuse;
        this.emit(':tellWithCard', speechOutput, SKILL_NAME, speechOutput);
    },
    'GetHomeworkExcuseIntent': function () {

        const excuseArray = DATA_HOMEWORK_EXCUSES;
        const excuseIndex = Math.floor(Math.random() * excuseArray.length);
        const randomExcuse = excuseArray[excuseIndex];
        const speechOutput = GET_EXCUSE_HOMEWORK_START + randomExcuse;
        this.emit(':tellWithCard', speechOutput, SKILL_NAME, speechOutput);
    },
    'GetAttendingExcuseIntent': function () {

        const excuseArray = DATA_ATTENDING_EXCUSES;
        const excuseIndex = Math.floor(Math.random() * excuseArray.length);
        const randomExcuse = excuseArray[excuseIndex];
        const speechOutput = GET_EXCUSE_ATTENDING_START + randomExcuse;
        this.emit(':tellWithCard', speechOutput, SKILL_NAME, speechOutput);
    },
